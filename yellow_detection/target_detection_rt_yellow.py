# Detecting yellow target in real time with drone camera (no distance calculations)
...
class StreamingExample(threading.Thread):
    ...
    def __init__(self):
        ...
        print("Target detection output dir: {}".format(self.tempd))
    ...
    def run(self):
        window_name = "Target Detection Stream"
